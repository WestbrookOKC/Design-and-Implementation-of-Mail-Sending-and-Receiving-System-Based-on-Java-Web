...
public class CSendBox extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        {
            //设置session中的页面值域
            mySession.setAttribute(CommonInfo.VIEWID_SENDBOXLIST, new Hashtable());
            //取得最新邮件
            MSendBox mSendBox = new MSendBox();
            mSendBox.getSaveMail(mySession);
            mySession.setAttribute("curPage","sendbox");
            resp.sendRedirect("/webmails/sendbox.jsp");
            return;
        }
